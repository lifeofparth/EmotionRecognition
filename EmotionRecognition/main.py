...
def load_dataset(img_folder):
    ...
    for dir in os.listdir(img_folder):
        ...
        print("Directory {0:} with folder {1:} has {2:} images".format(img_folder, dir, filesInDir))
    
    print("Total images in directory {0:}: {1:}".format(img_folder, len(img_data_array)))
...
def create_alex_model(train_images, train_labels, test_images, test_labels):
    ...
    history = model.fit(train_data, train_labels, epochs=20, batch_size= 2, validation_data=(test_data, test_labels), shuffle = True)
...
if __name__ == '__main__':
    ...
    print("Creating AlexNet model....training... and testing")
    create_alex_model(train_img_data, train_img_labels, test_img_data, test_img_labels)
